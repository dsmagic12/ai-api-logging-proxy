...
export class AnthropicStreamObserver {
    buffer = '';
    text = '';
    usage;
    responseSummary;
    ...
    handleJsonEvent(eventName, event) {
        ...
        if (event.type === 'content_block_delta') {
            ...
            if (event.delta?.type === 'thinking_delta' && typeof event.delta.thinking === 'string') {
                ...
                this.responseSummary = { ...this.responseSummary, has_thinking_delta: true };
            }
        }
...
export function normalizeAnthropicUsage(usage) {
    ...
    return {
        ...
        total_tokens: typeof inputTokens === 'number' || typeof outputTokens === 'number'
